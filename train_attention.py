...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Train a character-level seq2seq model with attention')
    ...
    parser.add_argument('-do', '--dropout', type=int, default=0.2, help='Neuron dropout')
    parser.add_argument('-cell_type', '--cell_type', choices=['LSTM', 'GRU', 'RNN'], default='GRU', help='Type of recurrent cell')
    parser.add_argument('-hs', '--hidden_size', type=int, default=256, help='Size of hidden unit')
    parser.add_argument('-nl', '--n_layers', type=int, default=3, help='No of hidden encoder/decoder layers')
    parser.add_argument('-in_emb', '--in_embed', type=int, default=64, help='Length of input embedding')    
...
def main(args):
    ...
    #Validation_accurac_checker and train function:
